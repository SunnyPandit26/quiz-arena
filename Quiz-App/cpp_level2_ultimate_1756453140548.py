...
try:
    ...
    plot_dir = os.path.dirname(r'C:\\Users\\sunny\\OneDrive\\Desktop\\quiz-kro\\quiz-arena\\Quiz-App\\quiz_results\\cpp_level2_ultimate_68b131107120dad9e358d0fa_2025-08-29T07_34_01_254Z_1756453140548.png')
    ...
    # Bar chart
    question_data = [{"questionNumber":1,"question":"Which header is needed to use std::cout in C++?","userAnswer":"#include <iostream>","correctAnswer":"#include <iostream>","isCorrect":True}]
    ...
    plot_path = r'C:\\Users\\sunny\\OneDrive\\Desktop\\quiz-kro\\quiz-arena\\Quiz-App\\quiz_results\\cpp_level2_ultimate_68b131107120dad9e358d0fa_2025-08-29T07_34_01_254Z_1756453140548.png'
    ...
    if os.path.exists(plot_path):
        ...
        print(json.dumps({"success": True, "filename": "cpp_level2_ultimate_68b131107120dad9e358d0fa_2025-08-29T07_34_01_254Z_1756453140548.png"}))
    else:
