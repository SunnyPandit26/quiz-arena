...
try:
    ...
    plot_dir = os.path.dirname(r'C:\\Users\\sunny\\OneDrive\\Desktop\\quiz-kro\\quiz-arena\\Quiz-App\\quiz_results\\cpp_level2_ultimate_68b131107120dad9e358d0fa_2025-08-29T07_35_33_978Z_1756453137044.png')
    ...
    # Bar chart
    question_data = [{"questionNumber":1,"question":"Missing Question Data","userAnswer":"Not Answered","correctAnswer":"N/A","isCorrect":False},{"questionNumber":2,"question":"Which of the following correctly declares a pointer in C++?","userAnswer":"int *p;","correctAnswer":"int *p;","isCorrect":True},{"questionNumber":3,"question":"Missing Question Data","userAnswer":"Not Answered","correctAnswer":"N/A","isCorrect":False},{"questionNumber":4,"question":"Which of the following is not a valid C++ data type?","userAnswer":"real","correctAnswer":"real","isCorrect":True},{"questionNumber":5,"question":"Missing Question Data","userAnswer":"Not Answered","correctAnswer":"N/A","isCorrect":False},{"questionNumber":6,"question":"Which operator is used to allocate memory dynamically in C++?","userAnswer":"malloc","correctAnswer":"new","isCorrect":False},{"questionNumber":7,"question":"Missing Question Data","userAnswer":"Not Answered","correctAnswer":"N/A","isCorrect":False},{"questionNumber":8,"question":"Which of the following is used to define a constant in C++?","userAnswer":"both A and B","correctAnswer":"both A and B","isCorrect":True},{"questionNumber":9,"question":"Missing Question Data","userAnswer":"Not Answered","correctAnswer":"N/A","isCorrect":False},{"questionNumber":10,"question":"Which of the following correctly creates an object in C++?","userAnswer":"class obj;","correctAnswer":"Class obj;","isCorrect":False}]
    ...
    plot_path = r'C:\\Users\\sunny\\OneDrive\\Desktop\\quiz-kro\\quiz-arena\\Quiz-App\\quiz_results\\cpp_level2_ultimate_68b131107120dad9e358d0fa_2025-08-29T07_35_33_978Z_1756453137044.png'
    ...
    if os.path.exists(plot_path):
        ...
        print(json.dumps({"success": True, "filename": "cpp_level2_ultimate_68b131107120dad9e358d0fa_2025-08-29T07_35_33_978Z_1756453137044.png"}))
    else:
